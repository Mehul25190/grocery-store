...
class WalletAddedCardPayment extends React.Component {
  ...
  render(){
    ...
    console.log(url.paymentURL + '/rechargeWallet.php?cardId='+cardId+'&cvv='+cvv+'&userId='+userId+'&amount='+amount);
...
{/* ---------------------------------Credit / Debit Card----------------------------------*/}
         ...
         <ScrollView style={{marginLeft:Layout.indent, marginRight:Layout.indent}}>
                  <WebView
                    source={{
                      uri: url.paymentURL + '/rechargeWallet.php?cardId='+cardId+'&cvv='+cvv+'&userId='+userId+'&amount='+amount
                    }}
...
// Exports
export default connect(mapStateToProps, mapDispatchToProps)(WalletAddedCardPayment);